                        ...
                        <div class="card-body">
                                ...
                                <div class="d-flex">
                                    @if($careBeneficiary->profile_picture == 'default.png')
                                        <div class="letter-avatar">
                                            <h6 class="txt-primary bg-light-primary">{{ $careBeneficiary->initials }}</h6>
                                        </div>
                                    @else
                                        <img class="img-70 rounded-circle" alt="Profile Picture" 
                                             src="{{ asset('uploads/profile_pictures/' . $careBeneficiary->profile_picture) }}">
                                    @endif
                            ...
                            <form action="{{ route('admin.bookings.update', $booking->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" id="start_date" name="start_date" class="form-control" required value="{{ $booking->start_date }}">
                                </div>
                
                                <div class="mb-3">
                                    <label for="end_date" class="form-label">End Date:</label>
                                    <input type="date" id="end_date" name="end_date" class="form-control" required value="{{ $booking->end_date }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="number_of_carers" name="number_of_carers" class="form-select" required>
                                        <option value="1" {{ $booking->number_of_carers == 1 ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ $booking->number_of_carers == 2 ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ $booking->number_of_carers == 3 ? 'selected' : '' }}>3</option>
                                    </select>
                                </div>
                        </div>
