...
@section('title', 'Admin - Add New Care Beneficiary')
...
@section('page-header')
    <h4 class="f-w-700">Add New Care Beneficiary</h4>
    <nav>
        <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i data-feather="home"></i></a></li>
            <li class="breadcrumb-item f-w-400">Admin Panel</li>
            <li class="breadcrumb-item f-w-400">Add Care Beneficiary</li>
        </ol>
    </nav>
@endsection
        ...
        <div class="edit-profile">
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <form class="card" method="POST" action="{{ route('admin.care-beneficiary.store') }}">
                        @csrf
                        <div class="card-header">
                            <h4 class="card-title mb-0">Add Care Beneficiary</h4>
                        </div>
                        <div class="card-body">
