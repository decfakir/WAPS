...
@section('page-header')
    <h4 class="f-w-700">Care Beneficiaries</h4>
    <nav>
        <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i data-feather="home"></i></a></li>
            <li class="breadcrumb-item f-w-400">Admin Panel</li>
            <li class="breadcrumb-item f-w-400">Care Beneficiaries</li>
        </ol>
    </nav>
@endsection
    ...
    <div class="container-fluid dashboard-3">
        ...
        <div class="card" style="background-color: rgba(255, 255, 255, 0.7); box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
            <div class="card-body d-flex justify-content-between align-items-center">
                 <a href="{{ route('admin.care-beneficiary.create') }}" class="btn btn-outline-primary">
        ...
        <div class="row">
                ...
                <div class="card pb-5">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top daily-revenue-card">
                            <h4>Total Care Beneficiaries</h4>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-sm-6">
                <div class="card pb-5">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top daily-revenue-card">
                            <h4>Active Care Beneficiaries</h4>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-sm-6">
                <div class="card pb-5">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top daily-revenue-card">
                            <h4>Eligble Care Beneficiaries</h4>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive theme-scrollbar">
                                <table class="table display" id="recent-orders" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($careBeneficiaries as $user)
                                            @php
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <a href="{{ route('admin.care-beneficiary.show', $user->id) }}">
