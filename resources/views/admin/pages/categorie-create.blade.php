        ...
        <div class="edit-profile">
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <form class="card" method="POST" action="{{ route('admin.categorie.store') }}">
                        @csrf
                        <div class="card-header">
                            <h4 class="card-title mb-0">Ajouter une nouvelle catégorie</h4>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer text-end">
                            <button class="btn btn-primary" type="submit">Ajouter Catégorie </button>
                        </div>
                    </form>
                </div>
            </div>
