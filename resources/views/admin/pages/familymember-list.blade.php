...
@section('title', 'Admin - Family Member List')
...
@section('page-header')
    <h4 class="f-w-700">Family Member List</h4>
    <nav>
        <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i data-feather="home"></i></a></li>
            <li class="breadcrumb-item f-w-400">Admin Panel</li>
            <li class="breadcrumb-item f-w-400">Family Member List</li>
        </ol>
    </nav>
@endsection
    ...
    <div class="container-fluid dashboard-3">
        ...
        <div class="card" style="background-color: rgba(255, 255, 255, 0.7); box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
            <div class="card-body d-flex justify-content-between align-items-center">
                 <a href="{{ route('admin.familymember.create') }}" class="btn btn-outline-primary">
        ...
        @if($familyMembers->isEmpty())
            <div class="alert txt-primary border-warning alert-dismissible fade show" role="alert">
                ...
                <p class="text-danger">No Family Member found.</p>
            </div>
        @else
            <div class="row">
                <div class="col-12">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <a href="{{ route('admin.familymember.show', $user->id) }}">
