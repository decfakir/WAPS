    ...
    <div class="container-fluid dashboard-3">
        ...
        <div class="card" style="background-color: rgba(255, 255, 255, 0.7); box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);">
            <div class="card-body d-flex justify-content-between align-items-center">
                 ...
                 <a href="{{ route('admin.knowledgebase.create') }}" class="btn btn-outline-primary" data-toggle="modal" data-target="#userSearchModal">
        ...
        @if($posts->isEmpty())
            <div class="alert txt-primary border-warning alert-dismissible fade show" role="alert">
                ...
                <p class="text-danger">No Knowledge Base posts found.</p>
            </div>
        @else
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body pt-0 recent-orders px-0">
                            <div class="table-responsive theme-scrollbar">
                                <table class="table display" id="post-list" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Title</th>
                                            <th>Category</th>
                                    ...
                                    <tbody>
                                        @foreach ($posts as $post)
                                            <tr>
                                                <td> <a href="{{ route('admin.knowledgebase.show', $post->id) }}"> {{ $post->title }}</a></td>
                                                <td>{{ ucfirst($post->category_formatted) }}</td>
