    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      <div class="page-header row">
        <div class="header-logo-wrapper col-auto">
          <div class="logo-wrapper"><a href="{{ route('carebeneficiary.dashboard') }}"><img class="img-fluid for-light" src="/dashboard-assets/images/logo/logo-2.png" alt=""/><img class="img-fluid for-dark" src="/dashboard-assets/images/logo/logo_lights.png" alt=""/></a></div>
        </div>
        ...
        <div class="header-wrapper col m-0">
          <div class="row">
            ...
            <div class="header-logo-wrapper col-auto p-0">
              <div class="logo-wrapper"><a href="{{ route('carebeneficiary.dashboard') }}"><img class="img-fluid" src="/dashboard-assets/images/logo/logo-2.png" alt=""></a></div>
