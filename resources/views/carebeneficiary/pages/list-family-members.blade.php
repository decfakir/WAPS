...
@section('title', 'Care Beneficiary - Family Members')
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0">
                                                            ...
                                                            @else
                                                                <img src="{{ asset('uploads/profile_pictures/' . $familyMember->profile_picture) }}" alt="Profile Picture" class="img-fluid rounded-circle" width="40">
                                                            @endif
                                                        </div>
                                                        <div class="flex-grow-1">
                                                            <a href="{{ route('carebeneficiary.family-member.show', $familyMember->id) }}">
                                                                <h6>{{ $familyMember->first_name . " " . $familyMember->last_name }}</h6>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
