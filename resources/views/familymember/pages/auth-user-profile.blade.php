...
@section('title', 'Family Member - Dashboard')
                ...
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="card w-100 border-top border-primary border-3">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <a href="{{ route('familymember.dashboard') }}" class="btn btn-outline-secondary">Dashboard</a>
                            <a href="{{ route('familymember.auth-profile.edit') }}" class="btn btn-secondary">Edit My Profile</a>
                        </div>
                    </div>
                </div>
            </div>
